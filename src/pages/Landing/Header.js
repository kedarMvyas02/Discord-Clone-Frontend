...
const Header = () => {
  ...
  return (
    <div className="bg-discord-heroBackground">
      ...
      <section className="flex mx-auto md:mt-15 mt-10 p-2 relative overflow-hidden">
        <img
          src={LeftHeaderImage}
          alt=""
        ...
        <div className="z-10 mx-auto flex items-center justify-between flex-col">
          <h3 className="w-full text-white md:text-6xl md:text-center text-left text-3xl sm:text-4xl px-4  uppercase font-bold">
            Imagine a place...
          </h3>
          ...
          <div className="w-full flex flex-col justify-start md:justify-start md:justify-center md:flex-row mt-8 mb-12 pb-40">
            <a
              href="https://discord.com/api/downloads/distributions/app/installers/latest?channel=stable&platform=win&arch=x86"
              target="_blank"
              rel="noopener noreferrer"
              className="w-36 sm:w-6/12 md:w-5/12 lg:w-4/12 lx:w-2/12 2xl:w-64 flex justify-center items-center bg-white text-discord-notQuiteDark py-3 px-6 rounded-full text-base mr-4"
            >
              <span className="inline-block mx-2">
                <svg className="fill-current w-6 h-6 pt-1" viewBox="0 0 24 24">
                  <g fill="currentColor">
                    <path d="M17.707 10.708L16.293 9.29398L13 12.587V2.00098H11V12.587L7.70697 9.29398L6.29297 10.708L12 16.415L17.707 10.708Z"></path>
                    <path d="M18 18.001V20.001H6V18.001H4V20.001C4 21.103 4.897 22.001 6 22.001H18C19.104 22.001 20 21.103 20 20.001V18.001H18Z"></path>
                  </g>
