    ...
    >
      <div className="flex flex-col md:flex-row sm:justify-between sm:justify-items-center">
        <div className="flex flex-col items-start">
          <h4 className="text-discord-experiment500 text-3xl text-blue-600 font-extrabold uppercase leading-none">
            Imagine a<br /> place
          </h4>
        ...
        <div className="flex flex-col md:flex-row md:flex-1 md:justify-between md:ml-20">
          <div className="flex flex-row md:hidden justify-between mt-10 md:mt-0">
            ...
            <div>
              <ul>
                ...
                <li className="mt-2">
                  <p className="text-white text-sm">Newsroom</p>
                </li>
              </ul>
            </div>
          </div>
          <div className="flex flex-row md:hidden justify-between mt-10 md:mt-0">
            <div>
              <ul>
                <li>
                  <p className="text-discord-experiment500 text-sm">
                    Resources
                  </p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm">Collage</p>
                </li>
                <li className="mt-2">
                ...
                <li className="mt-2">
                  <p className="text-white text-sm">Developrs</p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm">StreamKit</p>
                </li>
              </ul>
            </div>
            <div>
              <ul>
                <li>
                  <p className="text-discord-experiment500 text-sm sm:text-xs">
                    Policies
                  </p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm sm:text-xs">Terms</p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm sm:text-xs">Privacy</p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm sm:text-xs">Guidelines</p>
                </li>
                <li className="mt-2">
                ...
                <li className="mt-2">
                  <p className="text-white text-sm sm:text-xs">Licenses</p>
                </li>
                <li className="mt-2">
                  <p className="text-white text-sm sm:text-xs">Moderation</p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <ul>
              <li>
                <p className="text-discord-experiment500 text-sm">Company</p>
              </li>
              <li className="mt-2">
                <p className="text-white text-sm">About</p>
              </li>
          ...
          <div className="hidden md:block">
            <ul>
              <li>
                <p className="text-discord-experiment500 text-sm">Resources</p>
              </li>
              <li className="mt-2">
                <p className="text-white text-sm">Collage</p>
              </li>
