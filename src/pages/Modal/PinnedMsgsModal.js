...
const PinnedMsgsModal = ({ visible, where, onClose, id }) => {
  ...
  return (
    ...
    >
      <div className="z-10 bg-discord-semi600 w-full sm:w-4/6 md:w-4/6 lg:w-2/6 rounded-md p-5 m-12 flex flex-row mx-auto mt-16 overflow-scroll scrollbar-hide">
